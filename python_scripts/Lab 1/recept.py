...
def calcBakeTime(desiredServing):
    ...
    extraTime = 3  # Antaö extra minuter per person
...
def calcRecipe(desiredServing):
    ...
    print(f"Hur lång tid det kommer ta att göra smeten: {stirTime} minuter")
...
print(f"Hur lång tid det kommer ta att göra smeten: {calcStirTime(baseServing)} minuter")
